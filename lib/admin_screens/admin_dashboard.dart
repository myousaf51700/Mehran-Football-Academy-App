...
import 'package:mehran_football_academy/admin_screens/uploading_module/schedule_match.dart';
import 'package:mehran_football_academy/admin_screens/uploading_module/make_announcement.dart';
import '../my_components/my_drawers.dart';
import '../my_media/notifications.dart';
...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  Future<void> _loadData() async {
    ...
    final cachedData = prefs.getString('admin_dashboard_data');
  ...
  Future<void> _fetchChartData() async {
    ...
    try {
      ...
      if (topScorerResponse != null) {
        ...
        if (profileUrl != null) {
          await prefs.setString('admin_top_scorer_profile_$scorerUserId', profileUrl);
        }
      ...
      if (topAssisterResponse != null) {
        ...
        if (profileUrl != null) {
          await prefs.setString('admin_top_assister_profile_$assisterUserId', profileUrl);
        }
  ...
  void _handleFileUpload() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Navigating to file upload screen')),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: AdminFabMenu(
